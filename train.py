...
def get_args():
    ...
    parser.add_argument('--dataset', type=str, default='vk-users',
                        choices=['vk-users-r', 'vk-users-c', 'hm-products', 'hm-products-group', 'avazu-devices',
                                 'avazu-devices-v2', 'yp-maps', 'yp-maps-v2', 'yp-maps-large', 'yp-fraud',
                                 'yp-fraud-v2', 'yp-fraud-v3', 'yp-fraud-v4', 'yp-fraud-v5', 'yp-fraud-v6', 'yp-games',
                                 'yp-games-v2', 'yp-games-c', 'wb-forecast-v1', 'amazon-users-p', 'amazon-users-s',
                                 'amazon-users-v', 'tolokers-tab', 'questions-tab', 'socnet-recs'])
